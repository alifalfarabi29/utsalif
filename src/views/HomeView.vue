...
<template>
  ...
  <div class="x text-center">
    ...
    <br>
    <br>
    <h1 class="p">Selamat Datang di Al-Qur'an Ku</h1>
    <br />
    <img src="../assets/Golden1.png" alt="logo" width="400px" />
    <br />
    <br />
    <a type="button" class="pa btn btn-dark border-0" href="#1">Selamat Membaca</a>
  </div>
  <br />
  <br />
  <br />
  ...
  <div id="1">
    <div class="text-center">
      <h1 class="p">Masukkan nomor surah yang ingin anda baca &hearts;</h1>
    </div>
    <div class="search">
      <input
        v-model="cari"
...
.pa{
  font-family: Roboto;
  background: linear-gradient(45deg,#85586F, #AC7D88);
